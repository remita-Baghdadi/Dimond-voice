            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/images/icons/Bookmark.png"),
                ),
                SizedBox(
            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/images/icons/Paper.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/images/icons/Time Square.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
            ...
            icon: Column(
              children: [
                SizedBox(
                  ...
                  height: 24,
                  child: Image.asset(
                      "assets/images/icons/Arrow - Down Square.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image:
                              AssetImage("assets/images/icons/Volume Up.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                      ...
                      child: Opacity(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/icons/Arrow - Left Circle.png"),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/images/icons/Upload.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
